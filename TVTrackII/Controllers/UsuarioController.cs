...
namespace TVTrack.Controller
{
    public static class UsuarioController
    {
        ...
        // EVENTO: se dispara cuando se registra un nuevo usuario
        public static event Action? UsuarioAgregado;
        ...
        public static void AgregarUsuario(string nombre, string email, string contraseña, string rol)
        {
            ...
            // DISPARAR evento a los observadores (formularios suscritos)
            UsuarioAgregado?.Invoke();
        }
